...
#     ---------------------------------------------------------
    ...
    path('v1/members/special_day/', views.MemberSpecialDayView.as_view(),name="member_special_day_view"),
    path('v1/members/special_day/<str:member_ID>/', views.MemberSpecialDayView.as_view(),name="member_special_day_update_view"),
