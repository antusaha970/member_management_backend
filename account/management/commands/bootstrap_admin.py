    ...
    def create_admin_with_groups(self):
        try:
            ...
            all_permission_name = ["/groups", "group_delete", "group_create", "group_edit", "/reg", "group_management", "all_activity_log",
                                   "restaurant_management", "member_financial_management", "/members/add", "/members/view", "update_member", "delete_member", "promo_code_management", "event_management", "product_management", "facility_management", "/permissions"]
            permissions = []
