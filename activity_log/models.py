...
class ActivityLog(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=models.SET_NULL,null=True, related_name='activity_logs')
    ...
    device = models.CharField(max_length=255, default="Unknown Device", blank=True)
    ...
    def __str__(self):
        return f"Activity log for {self.user} at {self.timestamp}"
