...
class EventMedia(EventBaseModel):
    ...
    event = models.ForeignKey(Event, on_delete=models.RESTRICT, related_name="event_media")
...
class EventTicket(EventBaseModel):
    ...
    # ForeignKey relations
    event = models.ForeignKey(Event, on_delete=models.RESTRICT, related_name='event_tickets')
