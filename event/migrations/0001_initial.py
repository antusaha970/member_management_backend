    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='events_member', to='member.member')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='event_media', to='event.event')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'Available'), ('sold_out', 'Sold Out'), ('reserved', 'Reserved'), ('cancelled', 'Cancelled')], default='available', max_length=20)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='event_tickets', to='event.event')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='event',
            name='venue',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='events_at_venue', to='event.venue'),
        ),
        migrations.CreateModel(
            name='EventFee',
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='event_fees', to='event.event')),
                ('membership_type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='event_fees_membership_type', to='core.membershiptype')),
            ],
            options={
